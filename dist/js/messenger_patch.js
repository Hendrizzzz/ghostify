(() => {
  ...
  (function() {
    ...
    function isMessageRequestHydrationText(text) {
      const hasRequestContext = text.includes("message_requests") || text.includes("message request") || text.includes("message_request") || text.includes("messagerequests") || text.includes("message-requests") || text.includes("/requests");
