...
assert(
    notes.includes("### Added"),
    "current release notes should include the Added section",
);
assert(
    !notes.includes("## Historical Releases"),
    "release notes must stop at the next version heading",
);
assert.throws(
...
assert.throws(
    () => extractReleaseNotes(changelog, "release-2.0.4"),
    /must use X.Y.Z format/,
);
assert.strictEqual(
    assertDatedReleaseHeading(
        "## [1.2.3] - 2026-07-20\n\n- Release notes.",
