...
assert.strictEqual(
    normalizePackagedConfig({ version: "9.9.8", patterns: {} }, fallbackConfig),
    null,
);
assert.strictEqual(
    normalizePackagedConfig({ version: "9.9.9" }, fallbackConfig),
    null,
);
assert.strictEqual(
    normalizePackagedConfig(
        { version: "9.9.9", patterns: { igSeen: [] } },
        fallbackConfig,
    ),
    null,
...
assert.strictEqual(
    Object.prototype.hasOwnProperty.call(normalized.patterns, "unknown"),
    false,
);
