...
const GHOST_PATH =
  'M24 108V54c0-23.2 16.8-40 40-40s40 16.8 40 40v54c0 4.8-5.5 7.5-9.4 4.6l-9.1-6.8-9.1 6.8a7 7 0 0 1-8.4 0l-4-3-4 3a7 7 0 0 1-8.4 0l-9.1-6.8-9.1 6.8c-3.9 2.9-9.4.2-9.4-4.6Z';
const EYES_PATH =
  'M44 60c0-8.8 4.1-15 10-15s10 6.2 10 15-4.1 15-10 15-10-6.2-10-15Zm30 0c0-8.8 4.1-15 10-15s10 6.2 10 15-4.1 15-10 15-10-6.2-10-15Z';
const HIGHLIGHT_PATH =
  'M37 38c6.3-9 16-13.7 28.1-13.7 2.2 0 3.9 1.8 3.9 4s-1.8 3.8-4 3.8c-9.3 0-16.7 3.6-21.5 10.5a4 4 0 0 1-6.5-4.6Z';
