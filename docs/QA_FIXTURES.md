...
| `GH-FB-GROUP-SEND-001` | Facebook | With privacy controls enabled, a message sent in a Facebook group chat leaves Sending and is delivered normally while bundled typing and Seen metadata remain suppressed. |
