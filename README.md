...
| [Firefox Browser Add-ons (AMO)](https://addons.mozilla.org/en-US/firefox/addon/ghostify-privacy-controls/) | Firefox | Published |
...
Install Ghostify from [Firefox Browser Add-ons](https://addons.mozilla.org/en-US/firefox/addon/ghostify-privacy-controls/).
